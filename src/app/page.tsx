  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div id="benefits" className="py-12">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Experience the power of AI-driven RFP management that adapts to your needs
              </p>
            </div>
              ...
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
                <div className="flex flex-col">
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p className="flex-auto">Our AI engine automatically extracts key requirements and insights from RFP documents, saving hours of manual review.</p>
                  </dd>
                </div>
                <div className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p className="flex-auto">Improve your win rate by 40% with AI-driven insights and competitive analysis.</p>
                  </dd>
                </div>
                <div className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p className="flex-auto">Let AI handle repetitive tasks while you focus on strategy and winning more bids.</p>
                  </dd>
                </div>
              </dl>
            </div>
        ...
        {/* Call to Action */}
        <div className="relative z-10 isolate mt-16 px-6 py-16 sm:mt-20 sm:py-20 lg:px-8">
